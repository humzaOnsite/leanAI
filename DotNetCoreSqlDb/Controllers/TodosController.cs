...
namespace DotNetCoreSqlDb.Controllers
{
    ...
    public class TodosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Description,CreatedDate,Number")] Todo todo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Description,CreatedDate,Number")] Todo todo)
        {
            if (id != todo.ID)
            {
                return NotFound();
